package library.interfacesvsobjectsuperclass.example1.D;
...
public class EmployeeInfo{
    ...
    public static void main(String[] args) {
        ...
        //answer.forEach(employee -> System.out.println(employee));
     ...
     */
    private static boolean listsAreEqual(List<Employee> l1, List<Employee> l2) {
